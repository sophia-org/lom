...
//!
//! The diagnostic content proof negotiates, obtains one panel allocation,
//! transfers one immutable resource, raises one frame demand and submits a
//! complete candidate only under the Engine-issued permit. Its headless
